...
solicited for submission to OSDC Israel 2008. We're interested in a wide 
...
Classes and auditoriums include a projector and either a flip-board or a
white-board. You are expected to provide your own laptop. If you require
...
=head3 Short (20 minutes) and Standard (40 minutes)
...
will be placed on L<http://osdc.org.il/2008/>.  You will need to log in,
...
are traveling from overseas and require extra time to make arrangements)
